...
func mainUsageOtherOptions(o *os.File, argv0 string) {
	...
	fmt.Fprintf(o, "  -k                 Attempt to continue despite input-formatting errors when\n")
	fmt.Fprintf(o, "                     possible, instead of fataling the process which is the default.\n")
	fmt.Fprintf(o, "                     Partial results are sent to stderr.\n")
